...
const Carousel = () => {
  return (
    <nav id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <section class="carousel-inner">
      <figure class="carousel-item active">
        <img src={bridgeImage} class="d-block w-100 slide-pic"
      ...
      <figure class="carousel-item">
        <img src={snowboardingImage} class="d-block w-100 slide-pic"
      ...
      <figure class="carousel-item">
        <img src={basketballImage} class="d-block w-100 slide-pic"
